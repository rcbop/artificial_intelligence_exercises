...
public class EightQueenPuzzleMain {
	...
	public static void main(String[] args) {
		...
		case OPTION1:
			...
			// (demora um pouco, aproximadamente 40mil (8!) estados serem
			// analisados)
	...
	private static void solveFirstSolution(EightQueenPuzzle puzzle) {
		...
		Configuration solution = puzzle.greedySearchForSolution();
	...
	public static void printSolutionList(LinkedList<Configuration> solutionList, long durationTime) {
		...
		for (Configuration configuration : solutionList) {
			System.out.println("[" + (i++) + "] " + Arrays.toString(configuration.getQueensPosition()));
		}
	}
	...
	public static void printSolutionStats(Configuration solution, long durationTime) {
		...
		while (!solutionStack.isEmpty()) {
			...
			System.out.println(Arrays.toString(currentState.getQueensPosition()));
		}
		System.out.println();
	}
}
